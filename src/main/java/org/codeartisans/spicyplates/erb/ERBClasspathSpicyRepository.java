...
public class ERBClasspathSpicyRepository
        extends AbstractClasspathSpicyRepository
{

    public ERBClasspathSpicyRepository( String rootPackage, SpicyContext globalContext, SpicyFactory factory )
    {
        super( rootPackage, globalContext, factory );
    }

    public ERBClasspathSpicyRepository( String rootPackage )
    {
        super( rootPackage, new ERBSpicyFactory() );
    }
