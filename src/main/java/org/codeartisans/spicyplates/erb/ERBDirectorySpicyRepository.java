...
public class ERBDirectorySpicyRepository
        extends AbstractDirectorySpicyRepository
{

    public ERBDirectorySpicyRepository( File basedir )
    {
        super( basedir, null, new ERBSpicyFactory() );
    }

    public ERBDirectorySpicyRepository( File basedir, SpicyContext globalContext, SpicyFactory factory )
    {
