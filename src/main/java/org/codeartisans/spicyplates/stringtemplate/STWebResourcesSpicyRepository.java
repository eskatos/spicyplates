...
public class STWebResourcesSpicyRepository
        extends AbstractWebResourcesSpicyRepository
{

    public STWebResourcesSpicyRepository( ServletContext servletContext, SpicyContext globalContext, SpicyFactory factory )
    {
