...
public class ERubySpicyServlet
        extends AbstractSpicyServlet
{
    ...
    {
        return new ERubyClasspathSpicyRepository( rootPackage, globalContext, factory );
    }

    @Override
    protected SpicyRepository directoryRepository( SpicyContext globalContext, File rootDirectory )
    {
        return new ERubyDirectorySpicyRepository( rootDirectory, globalContext, factory );
    }

    @Override
    protected SpicyRepository webResourcesRepository( SpicyContext globalContext, ServletContext servletContext )
    {
        return new ERubyWebResourcesSpicyRepository( servletContext, globalContext, factory );
    }
