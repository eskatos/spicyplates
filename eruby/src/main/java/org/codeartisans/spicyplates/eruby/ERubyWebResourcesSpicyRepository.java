...
public class ERubyWebResourcesSpicyRepository
        extends AbstractWebResourcesSpicyRepository
{

    public ERubyWebResourcesSpicyRepository( ServletContext servletContext, SpicyContext globalContext, SpicyFactory factory )
    {
